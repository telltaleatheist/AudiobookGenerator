...
def register_all_engines():
    ...
    try:
        ...
        print(f"Warning: Could not register OpenAI engine: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not register Edge engine: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not register F5 engine: {e}")
    ...
    try:
        ...
        print(f"Warning: Could not register Bark engine: {e}")
